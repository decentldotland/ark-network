...
// export const ARWEAVE_ORACLE_ADDRESS = "jRGJtaBjfvDJgpQATUiW3mBbB_wp71xrUmeQBalrm3k" // v0.0.6
// EVM ADDRESSES
...
export const EVM_ORACLES_CONTRACTS = [ETH_ORACLE_ADDRESS, AURORA_TESTNET_ADDRESS, BSC_TESTNET_ADDRESS];
